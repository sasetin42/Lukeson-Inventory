...
export default function JobOrderTemplate() {
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-2xl font-bold">Job Order Template Customizer</h1>
                <Button>
                    ...
                    <Card className="p-8">
                        <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-sm"><strong>Invoice ID:</strong> JO-2025-001</p>
                                <p className="text-sm"><strong>Date:</strong> Jan 15, 2024</p>
                                {showDueDate && <p className="text-sm"><strong>Due Date:</strong> Feb 14, 2024</p>}
                                <p className="text-sm"><strong>Delivery Receipt Number:</strong> JO-2025-002</p>
                            </div>
                        </div>
