        ...
        <div className="py-4 text-xs">
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-4">
                    <Image src={logo} alt="Company Logo" width={60} height={60} style={{ width: 'auto', height: 'auto' }} className="max-h-14 max-w-20 object-contain shrink-0 mb-2" data-ai-hint="logo" />
                    <div>
